    ...
    if(this.state.activeTab === 0){
      return(
        <div className="projects-grid">
          ...
          <CardTitle style={{color: 'blue', height: '176px', background: 
          'url() center / cover'}} >My Portfolio</CardTitle>
            ...
            <CardActions border>
            <Button colored href="https://github.com/kauserahmed/kauserahmed.github.io">Github</Button>
            </CardActions>
          ...
          {/* Project 2 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: 'blue', height: '176px', background: 'url() center / cover'}} >Design Pad</CardTitle>
            <CardText>
            ...
            <CardActions border>
              <Button colored href = "https://github.com/kauserahmed/design-pad">GitHub</Button>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
            </CardMenu>
          </Card>
          ...
          {/* Project 3 */}
          <Card shadow={5} style={{minWidth: '450', margin: 'auto'}}>
            <CardTitle style={{color: 'blue', height: '176px', background: 'url() center / cover'}} >Fave Link</CardTitle>
            <CardText>
            ...
            <CardActions border>
              <Button colored href = "https://github.com/kauserahmed/FavLink/tree/master/web/FavLink">GitHub</Button>
            </CardActions>
            <CardMenu style={{color: '#fff'}}>
            </CardMenu>
          </Card>
