    ...
    render () {
        ...
        <Grid>
          <Cell col={4}>
            ...
            <h2 style={{paddingTop: '0em'}}>Kauser Ahmed</h2>
            ...
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
            <p>
            <a href= "https://drive.google.com/file/d/1-wYR8tEEDJpIUxZ2MPzlnr9666etvNed/view?usp=sharing" className="button"><i className="fa fa-download"></i><b>Download Resume</b></a>
            </p>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
          </Cell>
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Education
              ...
              Artificial Intelligence (AI), Machine learing"
               />
